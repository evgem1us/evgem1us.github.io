...
### Компонент "AAO Remove Mesh By Mask" {#aao-remove-mesh-by-mask}
...
3. Нужно указать файл маски.
   ...
   ![AAO Remove Mesh By Mask - Create](/img/guides/nondestructive_optimization/image-76.png)
...
6. В появившемся окне будет видна полупрозрачная базовая текстура, на которой белым будет выделено какая часть текстуры наложена на выбранный меш.  
   ![AAO Remove Mesh By Mask - View UV example](/img/docs/guides/nondestructive_optimization/4_rank_optimization/6_triangles/2_remove/image.png)
